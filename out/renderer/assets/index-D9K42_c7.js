...
function App() {
  ...
  const browserPaneRef = reactExports.useRef(null);
  const [address, setAddress] = reactExports.useState("https://www.google.com");
  const [browserUrl, setBrowserUrl] = reactExports.useState("https://www.google.com");
  const [detailsWidth, setDetailsWidth] = reactExports.useState(420);
  const [networkHeight, setNetworkHeight] = reactExports.useState(270);
  const [status, setStatus] = reactExports.useState(emptyStatus);
  const [captures, setCaptures] = reactExports.useState([]);
  const [collections, setCollections] = reactExports.useState([]);
  const [savedApis, setSavedApis] = reactExports.useState([]);
  ...
  const [selectedSavedApiId, setSelectedSavedApiId] = reactExports.useState();
  ...
  const [headerMode, setHeaderMode] = reactExports.useState("table");
  const [saveTarget, setSaveTarget] = reactExports.useState();
  const [saveName, setSaveName] = reactExports.useState("");
  const [saveTags, setSaveTags] = reactExports.useState("");
  const [saveCollectionName, setSaveCollectionName] = reactExports.useState("Default");
  const [contextMenu, setContextMenu] = reactExports.useState();
  const [showBrowser, setShowBrowser] = reactExports.useState(true);
  const [settings, setSettings] = reactExports.useState(defaultAppSettings);
  const [settingsCategory, setSettingsCategory] = reactExports.useState("startup");
  const [testRequest, setTestRequest] = reactExports.useState({ method: "GET", url: "", headers: {}, body: "" });
  const [testQueryRows, setTestQueryRows] = reactExports.useState([]);
  const [testHeaderRows, setTestHeaderRows] = reactExports.useState([]);
  const [testBodyRows, setTestBodyRows] = reactExports.useState([]);
  const [testBodyMode, setTestBodyMode] = reactExports.useState("raw");
  const [requestTab, setRequestTab] = reactExports.useState("query");
  const [responseTab, setResponseTab] = reactExports.useState("body");
  ...
  const [proxyTransition, setProxyTransition] = reactExports.useState();
  ...
  const availableDomains = reactExports.useMemo(() => {
    ...
    return Array.from(counts.entries()).map(([domain, count]) => ({ domain, count })).sort((left, right) => left.domain.localeCompare(right.domain));
  ...
  reactExports.useEffect(() => {
    if (!selectedCollectionId && collections.length > 0) {
      ...
      setExpandedCollectionIds((current) => /* @__PURE__ */ new Set([...current, collections[0].id]));
    }
  }, [collections, selectedCollectionId]);
  reactExports.useEffect(() => {
    if (selected) return;
  ...
  async function updateAppSettings(patch) {
    ...
    setSettings(nextSettings);
    if (patch.autoShowBrowser !== void 0) setShowBrowser(nextSettings.autoShowBrowser);
  }
  ...
  async function saveCapturedApi() {
    ...
    setExpandedCollectionIds((current) => /* @__PURE__ */ new Set([...current, saved.collectionId]));
    setMessage(`Saved ${saved.name} to ${saved.collectionName}`);
    setSaveTarget(void 0);
  }
  async function sendCollectionTest() {
  ...
  function startNetworkResize(event) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "app-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mode-rail", "aria-label": "Mode navigation", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 19 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Library, { size: 19 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 19 })
        }
      )
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "topbar-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              proxyTransition ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spinner", "aria-hidden": "true" }) : status.running ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 15 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              "System ",
              settings.systemProxyEnabled ? "ON" : "OFF"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Open certificate folder", onClick: () => window.steal.openCertificateFolder(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 16 }) })
      ] })
    ] }),
    activeMode === "capture" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ref: workspaceRef,
        className: "workspace",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "section",
            {
              ...
              children: [
                embeddedBrowserVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "browser-toolbar", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "traffic-controls", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Back", onClick: () => webviewRef.current?.goBack(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 17 }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Forward", onClick: () => webviewRef.current?.goForward(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 17 }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Reload", onClick: () => webviewRef.current?.reload(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCcw, { size: 16 }) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "address-bar", onSubmit: (event) => {
                      event.preventDefault();
                      navigate();
                    }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: address, onChange: (event) => setAddress(event.target.value), "aria-label": "URL" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Open URL", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 16 }) })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "webview",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "network-panel", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pane-heading", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Captured Traffic" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-actions", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          ...
                          children: [
                            settings.browserMode === "chrome" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 15 }) : embeddedBrowserVisible ? /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 15 }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: showFilterPanel ? "network-content with-filters" : "network-content", children: [
                    showFilterPanel && /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "filter-panel", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-panel-section", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-panel-heading", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-heading-actions", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-panel-section domain-section", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-panel-heading", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: availableDomains.length })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "domain-list", children: [
                          availableDomains.map(({ domain, count }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                          ...
                          availableDomains.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state compact", children: "No domains yet." })
                        ] })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "capture-table", children: filteredCaptures.map((capture) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `method ${capture.method.toLowerCase()}`, children: capture.method }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "url-cell", children: capture.url }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: capture.responseStatusCode || "-" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                            capture.durationMs,
                            "ms"
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatBytes(capture.responseSize) })
                        ]
                      },
                      capture.id
                    )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "details", children: selected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detail-title", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `method ${selected.method.toLowerCase()}`, children: selected.method }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: selected.url })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tabs", children: ["headers", "body", "response"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: tab === item ? "active" : "", onClick: () => setTab(item), children: item }, item)) }),
            tab === "headers" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              HeadersPanel,
              {
                exchange: selected,
                mode: headerMode,
            ...
            tab === "body" && /* @__PURE__ */ jsxRuntimeExports.jsx(CodeBlock, { value: selected.requestBody || "(empty request body)", language: languageFromBody(selected.requestBody, selected.requestHeaders["content-type"]) }),
            tab === "response" && /* @__PURE__ */ jsxRuntimeExports.jsx(CodeBlock, { value: selected.responseBody || "(empty response body)", language: languageFromBody(selected.responseBody, selected.responseHeaders["content-type"]) })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state", children: "Open a URL or configure another app to use the local proxy." }) })
        ]
      }
    ),
    activeMode === "collection" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "collection-view", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "collection-sidebar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pane-heading", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Collections" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: collections.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collection-list", children: collections.length > 0 ? collections.map((collection) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-tree-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: expandedCollectionIds.has(collection.id) ? "tree-chevron open" : "tree-chevron", size: 15 }),
                expandedCollectionIds.has(collection.id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { size: 15 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: collection.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: collection.itemCount })
              ]
            }
          ),
          expandedCollectionIds.has(collection.id) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collection-tree-apis", children: savedApis.filter((api) => api.collectionId === collection.id).map((api) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `method ${api.exchange.method.toLowerCase()}`, children: api.exchange.method }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: api.name })
              ]
            },
            api.id
          )) })
        ] }, collection.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state compact", children: "No collections yet." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "details collection-details", children: selectedSavedApi ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detail-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `method ${selectedSavedApi.exchange.method.toLowerCase()}`, children: selectedSavedApi.exchange.method }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: selectedSavedApi.name })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collection-meta", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedSavedApi.collectionName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedSavedApi.exchange.url })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "test-panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "test-request-line", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: testRequest.method, onChange: (event) => setTestRequest({ ...testRequest, method: event.target.value }), children: ["GET", "POST", "PUT", "PATCH", "DELETE", "HEAD"].map((method) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: method }, method)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: testRequest.url, onChange: (event) => setTestRequest({ ...testRequest, url: event.target.value }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary-action", onClick: sendCollectionTest, disabled: isSendingTest, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 16 }),
              " ",
              isSendingTest ? "Sending" : "Send"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "test-split", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "request-editor", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "test-tabs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: requestTab === "query" ? "active" : "", onClick: () => setRequestTab("query"), children: [
                  "Query(",
                  enabledCount(testQueryRows),
                  ")"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: requestTab === "headers" ? "active" : "", onClick: () => setRequestTab("headers"), children: [
                  "Headers(",
                  enabledCount(testHeaderRows),
                  ")"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: requestTab === "body" ? "active" : "", onClick: () => setRequestTab("body"), children: "Body" })
              ] }),
              requestTab === "query" && /* @__PURE__ */ jsxRuntimeExports.jsx(KeyValueEditor, { title: "Query Parameters", rows: testQueryRows, keyPlaceholder: "Key", valuePlaceholder: "Value", onChange: setTestQueryRows }),
              requestTab === "headers" && /* @__PURE__ */ jsxRuntimeExports.jsx(KeyValueEditor, { title: "Headers", rows: testHeaderRows, keyPlaceholder: "Header", valuePlaceholder: "Value", onChange: setTestHeaderRows }),
              requestTab === "body" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                KeyValueEditor,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "test-response", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "test-tabs response-tabs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: responseTab === "headers" ? "active" : "", onClick: () => setResponseTab("headers"), children: "Headers" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: responseTab === "body" ? "active" : "", onClick: () => setResponseTab("body"), children: "Body" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: responseTab === "metrics" ? "active" : "", onClick: () => setResponseTab("metrics"), children: "Metrics" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: testResult ? `${testResult.status}` : "-" })
              ] }),
              testError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "test-error", children: testError }),
              testResult ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                responseTab === "headers" && /* @__PURE__ */ jsxRuntimeExports.jsx(HeadersTable, { headers: testResult.headers }),
                responseTab === "body" && /* @__PURE__ */ jsxRuntimeExports.jsx(CodeBlock, { value: testResult.body || "(empty response body)", language: languageFromBody(testResult.body, testResult.headers["content-type"]) }),
                responseTab === "metrics" && /* @__PURE__ */ jsxRuntimeExports.jsx(MetricsPanel, { result: testResult })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state compact", children: "Send the request to inspect the latest response." })
            ] })
          ] })
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "empty-state", children: "Select a saved API." }) })
    ] }),
    contextMenu && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "context-menu-backdrop", onMouseDown: () => setContextMenu(void 0), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    activeMode === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-view", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "settings-sidebar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pane-heading", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Settings" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: settingsCategory === "startup" ? "settings-category active" : "settings-category", onClick: () => setSettingsCategory("startup"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Startup" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Proxy and browser defaults" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: settingsCategory === "browser" ? "settings-category active" : "settings-category", onClick: () => setSettingsCategory("browser"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Browser" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Embedded or Chrome mode" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-page", children: [
        settingsCategory === "startup" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-page-title", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Startup" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Choose what Steal turns on when the app opens." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SettingToggle,
            {
        ...
        settingsCategory === "browser" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-page-title", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Browser" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Select the browser surface used from the Capture view." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Browser mode" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Embedded stays inside Steal. Chrome launches a dedicated automation-style Chrome profile." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mode-choice", children: ["embedded", "chrome"].map((mode) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: settings.browserMode === mode ? "active" : "",
                onClick: () => void updateAppSettings({ browserMode: mode }),
                children: mode === "embedded" ? "内蔵" : "Chrome"
              },
              mode
            )) })
          ] }),
          settings.browserMode === "chrome" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Chrome launcher" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Opens Chrome with a Steal-specific user data directory, proxy, and remote debugging port 9222." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "primary-action", onClick: launchChrome, children: "Open Chrome" })
          ] })
        ] })
      ] })
    ] }),
    saveTarget && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-backdrop", onMouseDown: () => setSaveTarget(void 0), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "save-dialog", role: "dialog", "aria-modal": "true", "aria-labelledby": "save-dialog-title", onMouseDown: (event) => event.stopPropagation(), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "save-dialog-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { id: "save-dialog-title", children: "Save API" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            saveTarget.method,
            " ",
            saveTarget.responseStatusCode || "-"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Close", onClick: () => setSaveTarget(void 0), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 16 }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "save-dialog-body", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Name",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: saveName, onChange: (event) => setSaveName(event.target.value), autoFocus: true })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Tags",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: saveTags, onChange: (event) => setSaveTags(event.target.value), placeholder: "auth, smoke" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Collection",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("datalist", { id: "save-collection-options", children: collections.map((collection) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: collection.name }, collection.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "save-summary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Method" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: saveTarget.method }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Collection" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: saveCollectionName.trim() || "Default" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "URL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: saveTarget.url }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Captured" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: new Date(saveTarget.startedAt).toLocaleString() })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "save-dialog-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSaveTarget(void 0), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "primary-action", onClick: saveCapturedApi, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "statusbar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: status.running ? "Proxy running" : "Proxy stopped" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: status.error || message || `CA: ${status.caCertPath || "not generated yet"} | Set external clients to HTTP/HTTPS proxy 127.0.0.1:8899.` })
    ] })
  ] });
}
function startDocumentDrag(cursor, onMove) {
...
function SettingToggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: checked ? "switch-control active" : "switch-control", onClick: () => onChange(!checked), children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}) })
  ] });
}
function HeadersPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "headers-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "detail-toolbar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "segment-control", "aria-label": "Header display mode", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: mode === "table" ? "active" : "", onClick: () => onModeChange("table"), children: "Table" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: mode === "raw" ? "active" : "", onClick: () => onModeChange("raw"), children: "Raw" })
    ] }) }),
    mode === "raw" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CodeBlock, { value: headersView(exchange), language: "json" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "headers-table-scroll", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        HeaderSection,
        {
...
function HeaderSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "header-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-section-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: summary })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-table", role: "table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-row heading", role: "row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { role: "columnheader", children: "Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { role: "columnheader", children: "Value" })
      ] }),
      rows.length > 0 ? rows.map(([name, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-row", role: "row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { role: "cell", children: name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { role: "cell", children: headerValueToString(value) })
      ] }, name)) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "header-empty", children: "No headers captured." })
    ] })
  ] });
}
function KeyValueEditor({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "kv-editor", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kv-editor-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: `Add ${title} row`, onClick: () => onChange([...rows, emptyRow()]), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kv-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kv-heading" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kv-heading", children: "Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kv-heading", children: "Value" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kv-heading" }),
      rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kv-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: row.enabled && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 13, strokeWidth: 3 })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: row.key, placeholder: keyPlaceholder, onChange: (event) => updateRow(row.id, { key: event.target.value }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: row.value, placeholder: valuePlaceholder, onChange: (event) => updateRow(row.id, { value: event.target.value }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Remove row", onClick: () => removeRow(row.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14 }) })
      ] }, row.id))
    ] })
  ] });
}
function HeadersTable({ headers }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "headers-table-scroll response-headers", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-table", role: "table", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-row heading", role: "row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { role: "columnheader", children: "Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { role: "columnheader", children: "Value" })
    ] }),
    rows.map(([name, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-row", role: "row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { role: "cell", children: name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { role: "cell", children: value })
    ] }, name))
  ] }) });
}
function MetricsPanel({ result }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "metrics-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatBytes(result.size) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Headers" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: Object.keys(result.headers).length })
    ] })
  ] });
}
function CodeBlock({ value, language }) {
  const highlighted = reactExports.useMemo(() => highlightCode(value, language), [value, language]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "code-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "code",
    {
...
function highlightCode(value, language) {
  ...
  try {
    return {
      html: HighlightJS.highlight(value, { language: detectedLanguage, ignoreIllegals: true }).value,
...
function languageFromBody(value, contentType) {
  ...
  if (normalizedContentType.includes("javascript") || normalizedContentType.includes("ecmascript") || trimmed.startsWith("function ") || trimmed.startsWith("const ") || trimmed.startsWith("let ") || trimmed.startsWith("var ") || trimmed.startsWith("import ") || trimmed.startsWith("export ")) {
    return "javascript";
  }
...
function captureToCurl(capture) {
  const parts = ["curl", "-X", shellQuote(capture.method), shellQuote(capture.url)];
  const blockedHeaders = /* @__PURE__ */ new Set(["content-length"]);
  for (const [name, value] of Object.entries(capture.requestHeaders)) {
    if (blockedHeaders.has(name.toLowerCase()) || value === void 0) continue;
...
function compactEditableHeaders(headers) {
  const blocked = /* @__PURE__ */ new Set(["host", "content-length", "connection", "accept-encoding"]);
  return Object.fromEntries(
    Object.entries(headers).filter(([key]) => !blocked.has(key.toLowerCase())).map(([key, value]) => [key, Array.isArray(value) ? value.join(", ") : value || ""])
  );
}
function objectToRows(values) {
...
function splitUrlForEditing(url) {
  try {
...
function buildUrlWithQueryRows(url, rows) {
  try {
    const parsed = new URL(url);
    parsed.search = "";
...
function modeSummary(mode, filteredCount, captureCount, collectionCount, savedApiCount) {
